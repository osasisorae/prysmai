...
const tiers: Tier[] = [
  {
    ...
    features: [
      ...
      "Basic output policy compliance",
  ...
  },
  {
    ...
    features: [
      ...
      "ML-based toxicity scoring (6 dimensions)",
      "NER-based PII detection",
      "LLM-powered off-topic detection",
      "Full output policy compliance",
  ...
  },
  {
    ...
    features: [
      ...
      "Deep LLM security analysis",
      "ML toxicity + NER + off-topic detection",
      "Custom output policy rules",
      "PagerDuty & Slack alert channels",
  ...
  },
  {
    ...
    features: [
      ...
      "Full ML security suite (toxicity, NER, off-topic)",
      "Custom output policy engine",
      "All alert channels (PagerDuty, Slack, webhooks)",
...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Off-topic detection", free: "Keyword", pro: "LLM-powered", team: "LLM-powered", enterprise: "Custom" },
  { feature: "Toxicity scoring", free: "Keyword", pro: "ML 6-dimension", team: "ML 6-dimension", enterprise: "ML + Custom" },
  { feature: "NER PII detection", free: "—", pro: "✓", team: "✓", enterprise: "✓" },
  { feature: "Output policy engine", free: "Basic", pro: "Full", team: "Custom rules", enterprise: "Custom + audit" },
  { feature: "Alert channels", free: "Email", pro: "Email + Slack", team: "+ PagerDuty", enterprise: "All + custom" },
